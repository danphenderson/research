Let $\vf$ be an external force acting on a continuum of blood fluid.
...
\begin{definition}[Conservative-Momentum Balance Form]
    ...
    \begin{flalign*}
        \quad & \begin{cases*}
            ...
            \quad \Div(\vu) \;=\; 0,\qquad \rho \equiv \rho_0>0 \text{ (constant).}
        \end{cases*} &&
    \end{flalign*}
\end{definition}
...
\begin{flalign*}
    \quad \text{WSS} \defined \langle \vct{t_{blood}}, ~\vT\;\hat{n} \rangle \quad : \quad \begin{cases*}
