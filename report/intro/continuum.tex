...
\begin{flalign*}
    \quad \vahat(t, \vxi) &\defined \pd_t \vuhat(t, \vxi) = \pd_t^2 \vx(t, \vxi) \quad  \forallin{\vxi}{\OmgB(0)} &&\\
        ...
        &\equals \pd_t \vu(t, \vx) + \sum_{i=1}^{N} u_i(t, \vx) \pd_{x_i} \vu(t, \vx) \quad \forallin{(t, \vx)}{I_T \times \OmgBt} && \\
        \iff \va &\equals \pd_t \vu + \sum_{i=1}^{N} u_i \, \pd_{x_i} \vu &&\\
        &\equals \pd_t \vu + \inp{\nabla}{\vu} \vu \quad \text{ in } \OmgB. &&
\end{flalign*}
