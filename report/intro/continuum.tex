...
\begin{flalign*}
    \quad \vu(t, \vx) &\equals \big(\vuhat \circ (\id{I_T} \times \inv{\La_t})\big)\big(t, \vx\big). &&\\
            &\equals \vuhat\bigl(t, \inv{\La_t}(\vx)\bigr) &&\\
            & \equals \vuhat\bigl(t, \vxi\bigr) \quad \text{ s.t. } \vxi \equals \inv{\La_t}(\vx)
...
\begin{flalign*}
\quad \begin{cases}
    \dfrac{d}{dt}\,\vx(t;\vxi) \equals \vu\bigl(t,\vx(t;\vxi)\bigr), t \in I_T,  \\
    \vx(0;\vxi) \equals \vxi.
\end{cases} &&
\end{flalign*}
