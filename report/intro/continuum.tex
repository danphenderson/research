...
\end{flalign*}
Then given velocity feild $\hat{\vu}$ and the reference configuration $\Omg(0)$, we arrive at the
Cauchy problem
\begin{flalign*}
    \quad \begin{cases*}
...
Note, we may apply $D_t$ to velocity $\vu$ to obtain the acceleration. (see pg. 19 \cite{book2} for more details and examples)
