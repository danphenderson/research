...
releasing blood (resp.). The beat can be recongnized by the dimensionless paramter
\begin{flalign*}
        \quad W_0 & \defined \sqrt{\frac{\rho \omega U}{\eta U L^-2}}&&\\
        \quad & \;=\; \sqrt{L^2 \cdot \frac{\omega}{\mu}}&&
\end{flalign*}
r.t. as the Womersley number. Here,
...
\td{first place we introduce params.. formalize this more.}
