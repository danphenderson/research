...
\begin{document}
    ...
    \section{Introduction}
        ...
        \medskip Our report is organized as follows. \medskip

        We start by stating the report's motivation, then in Sec.~\ref{subsec:physiology} we
        provide a brief physiological review of the human circulatory system. We follow with
        ...
        the hemodynamic problem to describing blood’s motion as a continuum. In Sec.~\ref{subsec:bloodmodel} we discuss various rheological assumptions and 
        constitutive relations used to model blood as an incompressible fluid. In Sec.~\ref{subsec:ns} we derive
        the incompressible Newtonian Navier–Stokes (NS) equations governing the motion of blood
        in large vessels.
