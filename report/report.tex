...
\begin{document}
    ...
    \section{Introduction}
        ...
        After stating our motivation, we begin with physiological review of a Human's circulatory system in
        Sec.~\ref{subsec:pysiology}. Then Sec.~\ref{subsec:continuum} states the continuum hypothesis, a necessary posulate of
        fluid mechanics. We adopt the continuum hypothesis and treat blood as a continuous medium, then our hemodynamics 
        problem simplifies describing the motion of a continous media. In Sec.~\ref{subsec:blood-model}, we discuss assumptions
